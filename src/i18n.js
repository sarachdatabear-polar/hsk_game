...
export const STRINGS = {
  en: {
    ...
    "battle.promptChoose": "Choose the best answer to light the trail.",
  ...
  th: {
    ...
    "battle.promptChoose": "เลือกคำตอบที่ดีที่สุดเพื่อจุดโคมไฟบนเส้นทาง",
