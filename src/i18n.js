...
export const STRINGS = {
  en: {
    ...
    "howto.tapMeaning": "Choose the <b>correct meaning</b> to light the next lantern. Consecutive first-try answers build Lucky Flow.",
    ...
    "battle.promptChoose": "Choose the correct meaning to light the trail.",
    "battle.promptMeaning": "Choose the correct meaning to light the trail.",
    ...
    "battle.feedbackLearned": "Lantern lit — this word is growing stronger.",
  ...
  th: {
    ...
    "howto.tapMeaning": "เลือก<b>ความหมายที่ถูกต้อง</b>เพื่อจุดโคมดวงถัดไป การตอบถูกครั้งแรกต่อเนื่องจะสร้างจังหวะโชคดี",
    ...
    "battle.promptChoose": "เลือกความหมายที่ถูกต้องเพื่อจุดโคมไฟบนเส้นทาง",
    "battle.promptMeaning": "เลือกความหมายที่ถูกต้องเพื่อจุดโคมไฟบนเส้นทาง",
    ...
    "battle.feedbackLearned": "จุดโคมไฟแล้ว — คุณจำคำนี้ได้ดีขึ้นอีกขั้น",
