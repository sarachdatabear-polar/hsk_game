...
export const STRINGS = {
  ...
  th: {
    ...
    "street.welcomeDesc": "ของขวัญจากเซสชันแรก — เลือกที่วางให้โคมนี้",
    "street.meta": "{size} · เซ็ต{set} · {behavior}",
    ...
    "street.noMove": "ของชิ้นนี้ต้องใช้พื้นที่ว่างที่มีขนาดเหมาะสม",
    ...
    "street.reserveHint": "เหรียญที่กันไว้จะถูกเก็บไว้สำหรับงานถัดไป",
    "street.reserveBlocked": "เหรียญเหล่านั้นถูกกันไว้สำหรับงานของคุณ",
    ...
    "street.projectReserved": "เก็บไว้ให้คุณตราบใดที่ยังเป็นโปรเจกต์",
    "street.makeProject": "ตั้งเป็นสิ่งที่จะสร้างต่อไป",
    "street.currentProject": "สิ่งที่จะสร้างปัจจุบัน",
    ...
    "friend.metric.streak": "สถิติต่อเนื่อง (วัน)",
    ...
    "item.mahjong-table.desc": "โต๊ะสังสรรค์พร้อมสำหรับไพ่ชุดชนะ",
    ...
    "item.shaved-ice-cart.desc": "รถเข็นฤดูร้อนเสิร์ฟของหวานสีสันสดใส",
