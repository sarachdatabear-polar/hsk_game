...
~2,700 LOC shrank it from **687,216 → 577,332 B (−109,884)**.

Final measured headroom: **809,448 B after Phase 1 → 953,707 B (931 KB) after Phase 2.**
Repo/deploy weight also drops by the full ~5.96 MB of deleted assets. The dead-code removal
and the end of dual-surface branching are still the main point.
